...
<header class="bg-white shadow-sm fixed w-full z-50">
    <nav class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="hidden md:ml-8 md:flex md:space-x-8">
                    ...
                    <a href="/news" class="text-custom font-medium">📰News</a>
        ...
        <div id="mobile-menu" class="md:hidden hidden mt-3 space-y-3">
            ...
            <a href="/news" class="block text-custom font-medium border-b-2 border-green-600 pb-2">📰News</a>
...
<div class="flex items-center">
    ...
    <div class="max-w-7xl mx-auto px-4 py-16">
        <h2 class="text-3xl font-bold text-center text-green-700 mt-20 mb-12">Berita Terkini Tentang Lingkungan</h2>
